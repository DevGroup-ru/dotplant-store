...
$buttons = Yii::$app->user->can('core-extended-price-manage-create') ? Html::a(
    Icon::show('plus') . '&nbsp' . Yii::t('dotplant.store', 'New item'),
    [
        'extended-price-manage/edit',
        'returnUrl' => \DevGroup\AdminUtils\Helper::returnUrl(),
        'targetModelId' => $targetModel->id,
        'targetModelClass' => $targetModel::className(),
    ],
            ...
            'columns' => [
                ...
                [
                    ...
                    'buttons' => function ($model, $key, $index, $column) {
                        return [
                            'edit' => [
                                'url' => 'extended-price-manage/edit',
                                'icon' => 'pencil',
                                'class' => 'btn-primary',
                                'attrs' => ['parent_id'],
                            ...
                            'delete' => [
                                'url' => 'extended-price-manage/delete',
                                'icon' => 'trash-o',
                                'class' => 'btn-warning',
