...
class OrderHelper
{
     ...
     * @param $warehouse_id
     * @param int $quantity
     * @param bool $change_by_manager
     * @return bool
     */
    public static function addItem(Order $order, Goods $goods, $warehouse_id, $quantity = 1, $change_by_manager = false)
    {
        ...
        $orderItem = new OrderItem([
            ...
            'quantity' => $quantity,
            'change_by_manager' => $change_by_manager
        ]);
