...
class m160915_122543_dotplant_store_new_items_for_menu extends Migration
{
    protected $items = [
        [
            ...
            'added_by_ext' => 'store',
            'rbac_check' => 'dotplant-store-order-view',
        ...
        [
            ...
            'icon' => 'fa fa-money',
            'added_by_ext' => 'store',
            'rbac_check' => 'dotplant-store-payment-view',
        ...
        [
            ...
            'icon' => 'fa fa-truck',
            'added_by_ext' => 'store',
            'rbac_check' => 'dotplant-store-delivery-view',
        ...
        [
            ...
            'added_by_ext' => 'store',
            'rbac_check' => 'dotplant-store-order-status-view',
